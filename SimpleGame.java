...
public class SimpleGame {
	...
	public static void main(String[] args) {
		...
		System.out.println("What game to play, 1 or 2?");
		...
		if (choice == 1){
			System.out.println("What integer seconds do you want to convert?");
			game.convertTime(sc.nextInt());
		}
		else{
			System.out.println("What integer seconds do you want to sum?");
			game.digitsSum(sc.nextInt());
		}
		sc.close();
	}	
}